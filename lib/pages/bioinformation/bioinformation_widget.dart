        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              titlePadding: EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 0.0, 0.0),
            ),
            elevation: 0.0,
          ),
        ),
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              _model.apiResultris = await PredictionCall.call(
                                text:
                                    _model.dailyActivityDescTextController.text,
                              );
                            ...
                            onPressed: () async {
                              ...
                              await UsersTable().update(
                                data: {
                                  ...
                                  'diabetes': FFAppState().diabetes,
                                  'pregnant': FFAppState().pregnant,
                                  'breastFeeding': FFAppState().breastFeeding,
                                },
